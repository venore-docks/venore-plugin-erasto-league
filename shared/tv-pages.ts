...
// mostram. Eliminatórias (se existirem) sempre entram como página extra no fim.
export function buildTvPages(bracket: BracketView, standings: TeamStanding[], nextGame: NextGameView | null): TvPage[] {
  const pages: TvPage[] = [];
