          ...
          <DialogDescription>
            ...
            {impact &&
              (impact.eventCount > 0
                ...
                : "Este jogador não tem nenhum evento (gol/cartão/falta) registrado.")}
            {impact &&
              impact.mvpMatchCount > 0 &&
              ` Ele é o MVP de ${impact.mvpMatchCount} partida(s) — elas ficam sem MVP (dá pra escolher outro na súmula).`}
